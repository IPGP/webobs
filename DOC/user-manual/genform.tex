...
\begin{itemize}
	...
	\item WATERS: a template for water physico-chemical analysis,
	\item VOLCGAS: a template for gas chemical analysis (exists also in French),
	\item BOJAP: a template for gas ’Japanese box’ (KOH solution) analysis,
	\item EXTENSO: a template for extensometer measurements (exists also in French),
	\item FISSURO: a template for fissurometer measurements,
	\item RAINWATER: a template for rain water physico-chemical analysis,
	\item RIVERS: a template for river water physico-chemical analysis,
	\item SOILSOLUTION: a template for soil physico-chemical analysis,
\end{itemize}
...
\begin{itemize}
	...
	\item a \wokey{DATETIME\_FORMAT} format of date/time that will be used for all record (for input/display of data),
	...
	\item a \wokey{OPERATORS\_FILT}, flag, allows selection of an operator in the table display,
