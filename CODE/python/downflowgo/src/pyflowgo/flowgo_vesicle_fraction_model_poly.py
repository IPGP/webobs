...
class FlowGoVesicleFractionModelPoly(pyflowgo.base.flowgo_base_vesicle_fraction_model.
    ...
    """ This method considers the volume fraction of vesicle (bubbles) to vary using a quadratic expression with distance from the vent.

        %vesicles = vesicle_poly_a * math.pow(distance,2) + vesicle_poly_b * distance + vesicle_fraction

        for Kileauea 2018
        vesicle_fraction = 0.7415
