...
class FlowGoRelativeViscosityModelPhanThienPham1(pyflowgo.base.flowgo_base_relative_viscosity_model.
    ...
    def compute_relative_viscosity(self, state):
        ...
        relative_viscosity = (1. - (phi / (1. - vesicle_fraction))) ** (-5. / 2.) * (1. - vesicle_fraction) ** (-1.)
