		...
		if isok(P,'EXPORTS')
			...
			if any(~isnan(m0))
				E.infos = { ...
                    ...
                    sprintf('  Eastern (m UTM) = %1.0f , %1.0f',round(e0+minmax(xx))), ...
                    sprintf('  Northern (m UTM) = %1.0f , %1.0f',round(n0+minmax(yy))), ...
                    sprintf('  Elevation (m asl) = %1.0f , %1.0f',round(minmax(zz))), ...
					' ', ...
				};
				switch lower(mt)
				case 'pcdm'
