...
%
%   	DD2DMS(H,X,[DX,DY]) fixes DX and DY tick intervals.
%
%	Note: to adjust axis after a zoom, type DD2DMS again.
%
%	Author: Francois Beauducel <beauducel@ipgp.fr>
%	Created: 1999 at Osservatorio Vesuviano.
%	Updated: 2008-11-04

if nargin == 0, h = gca; end
if nargin < 2, x = -1; end
if nargin < 3, dxy = [1,1]; end
...
for i = 1:2
	...
	if m >= tickint(1,1)
		...
		dt = tickint(min(find(m >= tickint(:,1))),2);
	end
	if nargin > 2
		dt = dxy(i);
	end
