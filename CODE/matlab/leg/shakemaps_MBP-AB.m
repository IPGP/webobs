...
for i = 1:nb
	if test
	    ...
	    case 4
		DH.tps(i) = datenum(2007,11,29,19,00,0); DH.lat(i) = 14.99; DH.lon(i) = -61.03; DH.dep(i) = 152; DH.mag(i) = 7.4; DH.typ(i) = 2;
	    case 5
		DH.tps(i) = datenum(2008,10,11,10,41,15); DH.lat(i) = 19.282; DH.lon(i) = -64.832; DH.dep(i) = 25.8; DH.mag(i) = 6.1; DH.typ(i) = 2;
	    otherwise
	    end
    end
    % ==========================================================
