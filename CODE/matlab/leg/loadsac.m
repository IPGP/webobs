function [X,H]=load(filename);
%LOADSAC reads a SAC binary file.
%   [X,H]=LOADSAC('filename') reads SAC filename and returns:
...
% LOADSAC modified by F. Beauducel, April 2004
