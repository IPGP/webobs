function R = reversemelimelo_ab(D)
...
for i = 1:length(t)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Les relais prennent alternativement la position 0 ou 1, de la façon suivante :
    %                              +--------+--------+
    %                              |Relais 1|Relais 2|
    % +----------------------------+--------+--------+
    % |Mesure 1, résistances 1 à 8 |   0    |    1   |
    % +----------------------------+--------+--------+
    % |Mesure 2, résistances 9 à 16|   1    |    0   |
    % +----------------------------+--------+--------+
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if (sum(relais(:))==2)
	    % Mesure 2
