#!/usr/bin/perl -w
# ---------------- WEBOBS ------------------------
# Perl module: Webobs.pm
# Purpose: additional generic functions
# Authors: Alexis Bosson, Francois Beauducel
# Created: 2006-02-09
# Updated: 2012-04-26
...
# ---------------------------------------------------------------
# ----------- Sous Routine readFile -----------------------------
# ---------------------------------------------------------------
# Renvoie le contenu du fichier dans une array
# Aucun filtre sur les commentaires et les lignes vides
sub readFile
{
# ---- Lecture d'un fichier
	...
	my @contenu;
	if (-f $configFile) {
		open(FILE, "<$configFile") || die "WEBOBS: problem with file $configFile.\n";
...
# ---------------------------------------------------------------
# Renvoie le contenu du fichier dans une array
# Supprime les commentaires et les lignes vides
sub readCfgFile
{
# ---- Lecture d'un fichier
	my $configFile=$_[0];
...
# ------------ readKeyFile---------------------------------------
# ---------------------------------------------------------------
# Renvoie le contenu du fichier dans un hash $contenu{cle} = val
# Supprime les commentaires et les lignes vides
sub readKeyFile
{
# ---- Lecture d'un fichier
