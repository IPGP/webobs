...
function onInputNSEW(e) {
	var lat = document.formulaire.latwgs84.value;
	var lon = document.formulaire.lonwgs84.value;
	var ns = document.formulaire.latwgs84n.value;
	var ew = document.formulaire.lonwgs84e.value;
