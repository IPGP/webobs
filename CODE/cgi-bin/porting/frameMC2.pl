...
<frameset FrameBorder="10" scrolling="no" cols="*,600">
	<FRAME name="image" src="/cgi-bin/afficheSUDS2.pl?f=$fileGU&amp;id_evt=$id_evt" resize marginwidth=0 marginheight=0>
	<FRAME name="formulaire" src="/cgi-bin/formulaireMC2.pl?f=$fileGU&amp;id_evt=$id_evt" resize marginwidth=0 marginheight=0>
</frameset>
</html>
FIN
